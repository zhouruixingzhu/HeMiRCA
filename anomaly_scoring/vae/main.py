...
@click.option('--abnormalpath', help='The path of normal data', metavar='PATH',
              required=True, type=str)
@click.option('--outputpath', help='TThe path of output', metavar='PATH',
              required=True, type=str)
...
def main(trainpath, normalpath, abnormalpath, outputpath):
    ...
    output_file = os.path.join('result',
                               '{}_{}.csv'.format(config.flow_type or 'vae',
                                                  outputpath))
    valid_file = os.path.join('result',
    ...
    # model_file
    #model_name = ''
    model_name = os.path.join('result','md_{}_{}.model'.format(
